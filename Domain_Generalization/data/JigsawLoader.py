...
class JigsawNewDataset(data.Dataset):
    def __init__(self, data_path, names, labels, jig_classes=100, img_transformer=None, tile_transformer=None, patches=True,
                 bias_whole_image=None, relabel_flag=False):
